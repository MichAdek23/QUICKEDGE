        ...
        <div style={{
          ...
          overflow: 'hidden'
           ...
           <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: 'linear-gradient(135deg, #a78bfa, #6d28d9)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 4px 10px rgba(109, 40, 217, 0.4)' }}>
              ...
              <div>
                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, color: 'white' }}>Install Quick-Hedge</h3>
                <p style={{ margin: 0, fontSize: '0.85rem', color: '#a1a1aa', marginTop: '0.2rem' }}>Experience zero-latency operations natively on your device.</p>
              </div>
           </div>
