...
export default function ProfileClient({ userId, currentAvatarUrl }: { userId: string, currentAvatarUrl?: string }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
       ...
       <div style={{ paddingTop: '2rem', borderTop: '1px solid var(--card-border)' }}>
          ...
          <button onClick={handleConnectGoogle} disabled={linking} className="btn-secondary" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', width: 'fit-content' }}>
