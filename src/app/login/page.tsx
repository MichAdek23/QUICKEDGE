  ...
  return (
    <AuthLayout title="Welcome Back" subtitle="Sign in to access your materials.">
      ...
      <form action={login} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
            <label style={{ fontSize: '0.875rem', color: '#e4e4e7' }}>Password</label>
            <Link href="/forgot-password" style={{ fontSize: '0.8rem', color: '#a78bfa' }}>Forgot?</Link>
          </div>
      ...
      <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.9rem', color: '#a1a1aa' }}>
        Don't have an account? <Link href="/signup" style={{ color: '#a78bfa', fontWeight: 600 }}>Create one</Link>
      </p>
    </AuthLayout>
  );
}
